...
\begin{DoxyCode}{0}
\DoxyCodeLine{28         \{}
\DoxyCodeLine{29             Random rnd = \textcolor{keyword}{new} Random();}
\DoxyCodeLine{30             \textcolor{keywordtype}{int} NumConf = rnd.Next(1000000, 9000000);}
\DoxyCodeLine{31             \textcolor{keywordtype}{string} email = \mbox{\hyperlink{classInicio_1_1Registro_ab767617adc8dcd13a78c70824d55eb24}{TextBox1}}.Text;}
\DoxyCodeLine{32             \textcolor{keywordtype}{string} nombre = \mbox{\hyperlink{classInicio_1_1Registro_a24be4248d4791f6b323568f814f5e5c2}{TextBox2}}.Text;}
\DoxyCodeLine{33             \textcolor{keywordtype}{string} apellidos = \mbox{\hyperlink{classInicio_1_1Registro_adc45c7cdfd1ee0e80f517f1bb9e827ff}{TextBox3}}.Text;}
\DoxyCodeLine{34             \textcolor{keywordtype}{string} pass = \mbox{\hyperlink{classInicio_1_1Registro_a835108d17c8690d089f9ee129b2ff7f3}{TextBox4}}.Text;}
\DoxyCodeLine{35             \textcolor{keywordtype}{string} tipo = \mbox{\hyperlink{classInicio_1_1Registro_a6a93f0b66e0c307a8f53722f3f41ce91}{RadioButtonList1}}.Text;}
\DoxyCodeLine{36             \textcolor{keywordtype}{int} confirmado = 0;}
\DoxyCodeLine{37 }
\DoxyCodeLine{38             AccesoDatos paraConexion = \textcolor{keyword}{new} AccesoDatos();}
\DoxyCodeLine{39             SqlConnection conexionDesdeClase = paraConexion.conexionSql();}
\DoxyCodeLine{40             }
\DoxyCodeLine{41             \textcolor{keywordflow}{try}}
\DoxyCodeLine{42             \{}
\DoxyCodeLine{43                 \textcolor{keywordtype}{string} query = \textcolor{stringliteral}{"INSERT INTO Usuarios (email,nombre,apellidos,pass,numconfir,confirmado, tipo) VALUES ('"} + email + \textcolor{stringliteral}{"', '"} + nombre + \textcolor{stringliteral}{"','"} + apellidos + \textcolor{stringliteral}{"', '"} + pass + \textcolor{stringliteral}{"',"} + NumConf + \textcolor{stringliteral}{","} + confirmado + \textcolor{stringliteral}{" , '"} + tipo + \textcolor{stringliteral}{"')"};}
\DoxyCodeLine{44                 SqlCommand comando = \textcolor{keyword}{new} SqlCommand(query, conexionDesdeClase);}
\DoxyCodeLine{45                 \textcolor{keywordtype}{int} numReg = comando.ExecuteNonQuery();}
\DoxyCodeLine{46                 \mbox{\hyperlink{classInicio_1_1Registro_a1f3fd3c1774cb311690a4246ba5aca66}{Label7}}.Visible = \textcolor{keyword}{true};}
\DoxyCodeLine{47                 \mbox{\hyperlink{classInicio_1_1Registro_a1f3fd3c1774cb311690a4246ba5aca66}{Label7}}.Text = numReg.ToString() + \textcolor{stringliteral}{" registro(s) insertado(s) en la base de datos. Se ha enviado un email para confirmar el registro."};}
\DoxyCodeLine{48                 \textcolor{keywordflow}{try}}
\DoxyCodeLine{49                 \{}
\DoxyCodeLine{50                     ClassEmail Cr = \textcolor{keyword}{new} ClassEmail();}
\DoxyCodeLine{51                     MailMessage mnsj = \textcolor{keyword}{new} MailMessage();}
\DoxyCodeLine{52 }
\DoxyCodeLine{53                     mnsj.Subject = \textcolor{stringliteral}{"Confirmar registro"};}
\DoxyCodeLine{54 }
\DoxyCodeLine{55                     mnsj.To.Add(\textcolor{keyword}{new} MailAddress(email));}
\DoxyCodeLine{56 }
\DoxyCodeLine{57                     mnsj.From = \textcolor{keyword}{new} MailAddress(\textcolor{stringliteral}{"pruete001@ikasle.ehu.eus"}, \textcolor{stringliteral}{"Pilartxo Ruete"});}
\DoxyCodeLine{58 }
\DoxyCodeLine{59                     mnsj.Body =  \textcolor{stringliteral}{"Para validar el registro pulse el siguiente enlace: "} + Constantes.EnvioEmailConfir + email+\textcolor{stringliteral}{"\&numconf="}+NumConf+\textcolor{stringliteral}{""} ;}
\DoxyCodeLine{60                     \textcolor{comment}{/* Enviar */}}
\DoxyCodeLine{61                     Cr.MandarCorreo(mnsj);}
\DoxyCodeLine{62 }
\DoxyCodeLine{63                     \mbox{\hyperlink{classInicio_1_1Registro_a8f64d7bc53c3f17751f32a57cef78ddb}{Label8}}.Visible = \textcolor{keyword}{true};}
\DoxyCodeLine{64                     \mbox{\hyperlink{classInicio_1_1Registro_a8f64d7bc53c3f17751f32a57cef78ddb}{Label8}}.Text = \textcolor{stringliteral}{"El Mail se ha Enviado Correctamente."};}
\DoxyCodeLine{65                     \mbox{\hyperlink{classInicio_1_1Registro_aa4f71bea88748ad5dfc036a400cb4537}{HyperLink1}}.Visible = \textcolor{keyword}{true};}
\DoxyCodeLine{66                     \mbox{\hyperlink{classInicio_1_1Registro_aa4f71bea88748ad5dfc036a400cb4537}{HyperLink1}}.NavigateUrl = Constantes.EnvioEmailConfir + email + \textcolor{stringliteral}{"\&numconf="} + NumConf + \textcolor{stringliteral}{""};}
\DoxyCodeLine{67                     \mbox{\hyperlink{classInicio_1_1Registro_aa4f71bea88748ad5dfc036a400cb4537}{HyperLink1}}.Text = \textcolor{stringliteral}{"También puede validar su registro desde aquí"};}
\DoxyCodeLine{68                 \}}
\DoxyCodeLine{69                 \textcolor{keywordflow}{catch} (Exception exc)}
\DoxyCodeLine{70                 \{}
\DoxyCodeLine{71                     \mbox{\hyperlink{classInicio_1_1Registro_a8f64d7bc53c3f17751f32a57cef78ddb}{Label8}}.Visible = \textcolor{keyword}{true};}
\DoxyCodeLine{72                     \mbox{\hyperlink{classInicio_1_1Registro_a8f64d7bc53c3f17751f32a57cef78ddb}{Label8}}.Text = \textcolor{stringliteral}{"Ha habido algún problema con el envio de email "} + exc.ToString();}
\DoxyCodeLine{73                 \}}
\DoxyCodeLine{74             \}\textcolor{keywordflow}{catch} (Exception ex)}
\DoxyCodeLine{75                 \{}
\DoxyCodeLine{76                    \mbox{\hyperlink{classInicio_1_1Registro_a1f3fd3c1774cb311690a4246ba5aca66}{Label7}}.Visible = \textcolor{keyword}{true};}
\DoxyCodeLine{77                    \mbox{\hyperlink{classInicio_1_1Registro_a1f3fd3c1774cb311690a4246ba5aca66}{Label7}}.Text = \textcolor{stringliteral}{"Este usuario no ha podido registrarse "} + ex.ToString();}
\DoxyCodeLine{78                 \}}
\DoxyCodeLine{79                  conexionDesdeClase.Close();}
\DoxyCodeLine{80             }
\DoxyCodeLine{81             \}}
...
Hace referencia a Inicio.\+Registro.\+Hyper\+Link1, Inicio.\+Registro.\+Label7, Inicio.\+Registro.\+Label8, Inicio.\+Registro.\+Radio\+Button\+List1, Inicio.\+Registro.\+Text\+Box1, Inicio.\+Registro.\+Text\+Box2, Inicio.\+Registro.\+Text\+Box3 y Inicio.\+Registro.\+Text\+Box4.
...
\mbox{\Hypertarget{classInicio_1_1Registro_abb680432cdd29ebb5f813036c644dadc}\label{classInicio_1_1Registro_abb680432cdd29ebb5f813036c644dadc}} 
...
\mbox{\Hypertarget{classInicio_1_1Registro_